<template>
  <div>
    <div class="g_inputForm">
      编码：
      <el-input v-model="qcode" prefix-icon="el-icon-search" class="g_input" />姓名：
      <el-input v-model="qname" prefix-icon="el-icon-search" class="g_input" />值：
      <el-input v-model="qvalue" prefix-icon="el-icon-search" class="g_input" />
      <br>状态：
      ...
      <el-input v-model="qdescription" prefix-icon="el-icon-search" class="g_input" />
    ...
    >
      ...
      <el-table-column prop="code" label="编码" width="300px" align="center" />
      <el-table-column prop="name" label="名称" width="300px" align="center" />
      <el-table-column prop="value" label="值" width="400px" align="center" />
      <el-table-column prop="status" label="状态" width="400px" align="center" />
      <el-table-column prop="description" label="说明" width="400px" align="center" />
      <el-table-column prop="remark" :show-overflow-tooltip="true" label="备注" width="400px" align="center" />
