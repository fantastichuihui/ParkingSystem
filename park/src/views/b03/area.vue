<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="number" label="作业区号" align="center" />
      <el-table-column prop="name" label="作业区名称" align="center" />
      <el-table-column prop="state" label="使用状态" align="center" />
      <el-table-column v-if="false" prop="s_id" label="库房ID" width="300px" align="center" />
      <el-table-column
        v-if="false"
        prop="s_chargeName"
        label="负责人姓名"
...
export default {
  ...
  data: () => {
    return {
      ...
      state: undefined,
      s_id: undefined,
      s_chargeName: undefined,
      p_id: undefined,
      p_province: undefined,
      p_city: undefined,
      p_concateName: undefined,
      p_concatePhone: undefined,
      version: undefined,
      page: 1,
      rows: 10,
      resultlength: 10,
  ...
  methods: {
    search: function() {
      axios
        .get('/api/b03res/area/search', { params: this.getParam() })
        .then(res => {
    ...
    handleDelete() {
      ...
      axios
        .put('/api/b03res/area/delete', data)
        .then(response => {
    ...
    // 重置搜索框
    handclearsearch() {
      this.g_p_name = undefined
      this.g_s_name = undefined
      this.search()
    },
